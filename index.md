...
| [`inspect_demodata()`](https://growthcharts.org/jamesclient/reference/inspect_demodata.md) | Upload demo child data and download parsed file |
...
The functions below are not needed anymore, and will be deprecated in
the future.
...
|------------------|--------------------------|--------------------------------------------------------------------------------|
| `request_site()` | Create personalised site | [`james_post()`](https://growthcharts.org/jamesclient/reference/james_post.md) |
| `upload_bds()`   | Upload and parse data    | [`james_post()`](https://growthcharts.org/jamesclient/reference/james_post.md) |
