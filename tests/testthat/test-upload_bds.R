...
#           expect_equal(status_code(upload_bds(jtf[3], host = host, path = path)), 201))
#
# test_that("test4.json (wrong type) PASSES",
#           expect_equal(status_code(upload_bds(jtf[4], host = host, path = path)), 201))
#
# test_that("test5.json (missing ClientGegevens) PASSES",
#           expect_equal(status_code(upload_bds(jtf[5], host = host, path = path)), 201))
#
...
#           expect_equal(status_code(upload_bds(jtf[10], host = host, path = path)), 201))
#
