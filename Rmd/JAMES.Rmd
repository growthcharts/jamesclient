...
The URL ending in (`R/.val`) contain a JSON string with 1) the results 
of the screening, and 2) the url with a dedicated web site (see below).

As before, we may do the same thing by uploading the JSON file with the data:
...
- https://github.com/stefvanbuuren/jamesclient
- https://github.com/stefvanbuuren/growthscreener
